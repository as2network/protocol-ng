contract("AS2networkUser", async accounts => {
  ...
  it("Set string attribute and retrieve it", async () => {
    await userContract.setStringAttribute(key, stringValue, {
      from: rootAddress,
    });
  ...
  it("Set string and delete the value and try to retrieve it", async () => {
    ...
    await userContract.deleteStringAttribute(key, {
      from: rootAddress,
    });
  ...
  it("Override string key and retrieve", async () => {
    ...
    await userContract.setStringAttribute(key, newStringValue, {
      from: rootAddress,
    });
  ...
  it("Define string array key and retrieve the value", async () => {
    ...
    await userContract.setStringArrayAttribute(key, firstStringValue, {
      from: rootAddress,
    });

    await userContract.setStringArrayAttribute(key, secondStringValue, {
      from: rootAddress,
    });
  ...
  it("Set number attribute and retrieve it", async () => {
    await userContract.setNumberAttribute(key, numberValue, {
      from: rootAddress,
    });
  ...
  it("Set number attribute, delete it and retrieve it", async () => {
    ...
    await userContract.deleteNumberAttribute(key, {
      from: rootAddress,
    });
  ...
  it("Set number attribute from no owner account and retrieve it", async () => {
    try {
      await userContract.setNumberAttribute(key, stringValue, {
        from: invalidAccount,
      });
    } catch {
      assert.ok("ok");
  ...
  it("Override number key and retrieve", async () => {
    ...
    await userContract.setNumberAttribute(key, newNumberValue, {
      from: rootAddress,
    });
  ...
  it("Define number array key and retrieve the value", async () => {
    ...
    await userContract.setNumberArrayAttribute(key, firstNumberValue, {
      from: rootAddress,
    });

    await userContract.setNumberArrayAttribute(key, secondNumberValue, {
      from: rootAddress,
    });
  ...
  it("Define number array key, delete the first element and retrieve the value", async () => {
    ...
    await userContract.deleteNumberArrayAttribute(key, 0, {
      from: rootAddress,
    });
  ...
  it("Set address attribute and retrieve it", async () => {
    await userContract.setAddressAttribute(key, addressValue, {
      from: rootAddress,
    });
  ...
  it("Set address attribute, delete and retrieve it", async () => {
    ...
    await userContract.deleteAddressAttribute(key, {
      from: rootAddress,
    });
  ...
  it("Override address key and retrieve", async () => {
    ...
    await userContract.setAddressAttribute(key, newAddressValue, {
      from: rootAddress,
    });
  ...
  it("Define address array key and retrieve the value", async () => {
    await userContract.setAddressArrayAttribute(key, addressValue, {
      from: rootAddress,
    });

    await userContract.setAddressArrayAttribute(key, newAddressValue, {
      from: rootAddress,
    });
  ...
  it("Define address array key, delete the first element and retrieve the value", async () => {
    ...
    await userContract.deleteAddressArrayAttribute(key, 0, {
      from: rootAddress,
    });
  ...
  it("Set boolean attribute and retrieve it", async () => {
    await userContract.setBooleanAttribute(key, boolValue, {
      from: rootAddress,
    });
  ...
  it("Set boolean attribute, delete and retrieve it", async () => {
    ...
    await userContract.deleteBooleanAttribute(key, {
      from: rootAddress,
    });
  ...
  it("Override boolean key and retrieve", async () => {
    ...
    await userContract.setBooleanAttribute(key, newBoolValue, {
      from: rootAddress,
    });
  ...
  it("Define boolean array key and retrieve the value", async () => {
    ...
    await userContract.setBooleanArrayAttribute(key, firstBooleanValue, {
      from: rootAddress,
    });

    await userContract.setBooleanArrayAttribute(key, secondBooleanValue, {
      from: rootAddress,
    });
  ...
  it("Define boolean array key, delete the first value and retrieve the value", async () => {
    ...
    await userContract.deleteBooleanArrayAttribute(key, 0, {
      from: rootAddress,
    });
